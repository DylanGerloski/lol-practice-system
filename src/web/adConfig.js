...
// Ad configuration. `enabled` stays false until the human
// creates real ad units in AdSense and supplies the slot ids -- that's a
// real account/ToS action, not something a build does on
